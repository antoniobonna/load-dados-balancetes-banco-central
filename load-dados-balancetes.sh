...
DIR="/home/ubuntu/scripts/load-dados-balancetes-banco-central"
DUMP="/home/ubuntu/scripts/dump"
STARTDATE=$(date +'%F %T')
SCRIPTNAME="load-dados-balancetes.sh"
...
ListaArquivos="load_balancetes.py"
...
ListaArquivos="etl_dw_balancetes.sql"
for FILE in $ListaArquivos; do
	LoadDW $FILE
	done
